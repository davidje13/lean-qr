...
describe('corrections', () => {
  ...
  it('divides input data into groups', () => {
    for (let version = 1; version <= 40; ++version) {
      ...
      for (let level = 0; level < 4; ++level) {
        ...
        expect(total).toEqual(item._capacityBytes);
      }
    }
  });
  ...
  it('contains no empty or 0-count groups', () => {
    for (let version = 1; version <= 40; ++version) {
      ...
      for (let level = 0; level < 4; ++level) {
        ...
        expect(item._groups[0][0]).toBeGreaterThan(0);
        expect(item._groups[0][1]).toBeGreaterThan(0);
        // groups[1][0] is allowed to be 0
        expect(item._groups[1][1]).toBeGreaterThan(0);
      }
    }
  });
  ...
  it('stores more data in larger versions', () => {
    for (let level = 0; level < 4; ++level) {
      let last = getData(1)(level)._capacityBytes;
      for (let version = 2; version <= 40; ++version) {
        const cur = getData(version)(level)._capacityBytes;
  ...
  it('stores less data with more robust correction levels', () => {
    for (let version = 1; version <= 40; ++version) {
      const versionData = getData(version);
      let last = versionData(0)._capacityBytes;
      for (let level = 1; level < 4; ++level) {
        const cur = versionData(level)._capacityBytes;
  ...
  /* prettier-ignore */
  const dataset = {
     1: { L: [ 7, [ 1, 19], null    ], M: [10, [ 1, 16], null    ], Q: [13, [ 1, 13], null    ], H: [17, [ 1,  9], null    ] },
     2: { L: [10, [ 1, 34], null    ], M: [16, [ 1, 28], null    ], Q: [22, [ 1, 22], null    ], H: [28, [ 1, 16], null    ] },
     3: { L: [15, [ 1, 55], null    ], M: [26, [ 1, 44], null    ], Q: [18, [ 2, 17], null    ], H: [22, [ 2, 13], null    ] },
     4: { L: [20, [ 1, 80], null    ], M: [18, [ 2, 32], null    ], Q: [26, [ 2, 24], null    ], H: [16, [ 4,  9], null    ] },
     5: { L: [26, [ 1,108], null    ], M: [24, [ 2, 43], null    ], Q: [18, [ 2, 15], [ 2, 16]], H: [22, [ 2, 11], [ 2, 12]] },
     6: { L: [18, [ 2, 68], null    ], M: [16, [ 4, 27], null    ], Q: [24, [ 4, 19], null    ], H: [28, [ 4, 15], null    ] },
     7: { L: [20, [ 2, 78], null    ], M: [18, [ 4, 31], null    ], Q: [18, [ 2, 14], [ 4, 15]], H: [26, [ 4, 13], [ 1, 14]] },
     8: { L: [24, [ 2, 97], null    ], M: [22, [ 2, 38], [ 2, 39]], Q: [22, [ 4, 18], [ 2, 19]], H: [26, [ 4, 14], [ 2, 15]] },
     9: { L: [30, [ 2,116], null    ], M: [22, [ 3, 36], [ 2, 37]], Q: [20, [ 4, 16], [ 4, 17]], H: [24, [ 4, 12], [ 4, 13]] },
    10: { L: [18, [ 2, 68], [ 2, 69]], M: [26, [ 4, 43], [ 1, 44]], Q: [24, [ 6, 19], [ 2, 20]], H: [28, [ 6, 15], [ 2, 16]] },
    11: { L: [20, [ 4, 81], null    ], M: [30, [ 1, 50], [ 4, 51]], Q: [28, [ 4, 22], [ 4, 23]], H: [24, [ 3, 12], [ 8, 13]] },
    12: { L: [24, [ 2, 92], [ 2, 93]], M: [22, [ 6, 36], [ 2, 37]], Q: [26, [ 4, 20], [ 6, 21]], H: [28, [ 7, 14], [ 4, 15]] },
    13: { L: [26, [ 4,107], null    ], M: [22, [ 8, 37], [ 1, 38]], Q: [24, [ 8, 20], [ 4, 21]], H: [22, [12, 11], [ 4, 12]] },
    ...
    21: { L: [28, [ 4,116], [ 4,117]], M: [26, [17, 42], null    ], Q: [28, [17, 22], [ 6, 23]], H: [30, [19, 16], [ 6, 17]] },
    22: { L: [28, [ 2,111], [ 7,112]], M: [28, [17, 46], null    ], Q: [30, [ 7, 24], [16, 25]], H: [24, [34, 13], null    ] },
    ...
    32: { L: [30, [17,115], null    ], M: [28, [10, 46], [23, 47]], Q: [30, [10, 24], [35, 25]], H: [30, [19, 15], [35, 16]] },
  ...
  it(
    ...
    (version, level) => {
      ...
      const simpleGroups = info._groups.map((g) => (g[0] ? g : null));
      expect(info._ecSize).toEqual(ecSize);
      expect(simpleGroups).toEqual(groups);
    },
  );
});
